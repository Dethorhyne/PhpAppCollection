...
<html>
<head>
<title>Njewz - <?php echo($_POST['Title']); ?></title>
<meta charset="utf-8">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            <ol class="breadcrumb">
              <li><a href="index.php">Home</a></li>
              <li><a href="#"><?php echo($_POST['Category']); ?></a></li>
            </ol>
            <h1><?php echo($_POST['Title']); ?></h1>
            <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i>Tomislav Vukelić</a> <span><i class="fa fa-calendar"></i>4:20 PM</span> <a href="#"><i class="fa fa-tags"><?php echo($_POST['Category']); ?></i></a> </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="footer_widget wow fadeInDown">
            ...
            <ul class="tag_nav">
              ...
              <li><a href="#">Moda</a></li>
              <li><a href="#">Poslovanje</a></li>
              <li><a href="#">Život i stil</a></li>
